...
import AllOrders from "@/packages/ui/src/components/sales/all-orders";
import LatestEarnings from "@/packages/ui/src/components/sales/latest-earnings";
import RecentOrders from "@/packages/ui/src/components/sales/recent-orders";

//TODO: If needed, replace.
        ...
        <div className="space-y-5">
          <div className="flex flex-col md:flex-row justify-between items-start space-y-5 md:space-y-0 md:space-x-5">
            <div className="w-full md:w-1/3 grid grid-cols-2 gap-4">
              ...
              <div className="bg-black text-white rounded-lg p-5">
                <div className="text-2xl font-black">{stats?.totalAmount}</div>
