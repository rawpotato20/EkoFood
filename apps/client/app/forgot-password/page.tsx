            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-sm">
              <div className="flex flex-col justify-between space-y-2">
                ...
                <div className="w-full flex justify-end">
                  ...
                  >
                    {loading2 ? "Siunčiama..." : "Siųsti patvirtinimą"}
                  </button>
                </div>
              </div>
              {otpSent && !otpVerified && (
                <div className="flex flex-col justify-between space-y-2">
                  ...
                  <div className="w-full flex justify-end">
                    ...
                    >
                      {loading3 ? "Tikrinama..." : "Patvirtinti"}
                    </button>
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col relative">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    trackEventFunction(
                      "Forgot Password Confirm Password Entered"
                    );
                  }}
                ...
                {/* Eye Icon */}
                <span
                  onClick={() => setShowPassword2(!showPassword2)} // Toggle show/hide password
                  className="absolute right-4 top-2 cursor-pointer text-gray-600"
                >
                  {showPassword2 ? (
                    <AiFillEyeInvisible size={24} />
