  ...
  return (
    <>
      ...
      <div className="container mx-auto px-3 md:px-0 mt-10 mb-56 h-96 text-base">
        ...
        <br />
        Dėžė yra pristatoma kiekvieno mėnesio paskutinę savaitę, tą pačią
        savaitę yra automatiškai nuoskaičiuojami pinigai už jūsų dėžę (iki kol
        nesustabdysite automatinio mokėjimo). Pristatome visoje Lietuvoje per
        paštomatus.
        <br />
        Informacija apie paštomatų pasirinkimą ir pristatymo įkainius yra
        išdėstyta pradėjus mokėjimo procesą ir priėjus prie pristatymo skilties.
        <br />
        <br />
        <b>Grąžinimo politika</b>
        <br />
        Kadangi priekiaujame maistu, t.y., prekėmis kurios turi galiojimo datą,
        dėžė ir visas jos turinys nėra grąžinami.
        <br />
        <br />
