    ...
    return (
        <>
            ...
            <div className="container mx-auto px-3 md:px-0 mt-10 mb-24 h-96 text-lg">
                Mums yra svarbi jūsų nuomonė, nes ji padeda mūsų svetainei ir
                verslui tobulėti, todėl jeigu turite kokių nors klausimų ar
                pastabų, su mumis galite susisiekti čia:
                <br />
