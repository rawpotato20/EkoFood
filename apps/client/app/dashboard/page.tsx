import DashboardNav from "@/components/basic/dashboard-nav";
import Footer from "@/components/basic/footer";
import DashBox from "@/components/dashboard/dash-box";
import DashCart from "@/components/dashboard/dash-cart";
import DashProducts from "@/components/dashboard/dash-products";
            ...
            <div className="bg-secondary overflow-hidden relative">
              <div className="w-full flex items-center justify-center whitespace-nowrap py-1 px-4">
                <span className="text-sm md:text-base  text-white  text-center">
                  10% nuolaida <span className="font-extrabold">Jums</span> nuo pirmo
                  užsakymo!
                </span>
              </div>
            </div>
