...
async function getPageData(): Promise<{ ad: Ad; welcomeData: WelcomeData }> {
  const id = "gauk";
  ...
  return {
    ...
    welcomeData: {
      ...defaultWelcomeData,
      heading2: settingsRes.data.ads_title || "",
    },
  };
}

const GaukAdPage = async () => {
  ...
  return (
    <>
      ...
      >
        <div
          className="black-div-logo flex justify-center items-center py-4"
          data-aos="fade-down"
        >
          <Image
            src={ad.logo}
        ...
        <div className="w-full h-[450px] md:h-[800px] px-6">
          {/* <Image
                        src={ad.image}
                        alt={ad.title}
                        width={1920}
                    ...
                    /> */}
          {/* <h1
            className="text-4xl text-center mt-8 font-medium text-white"
            data-aos="fade-up"
          >
            Visada norėjau maitintis sveikiau, bet man per daug sudėtinga.
          </h1> */}
        </div>
        <div className="space-y-5 black-div-3 text-white">
