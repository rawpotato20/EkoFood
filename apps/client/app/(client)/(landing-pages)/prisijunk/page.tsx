...
async function getPageData() {
  ...
  const titleRes = await fetch(`${process.env.WEB_URL}/api/view/settings`, {
    cache: "no-store",
  });
  const titleJson = await titleRes.json();

  const ad = adJson.success ? adJson.data : {};
  const heading2 = titleJson?.data?.ads_title || "";
      ...
      >
        ...
        >
          <Image
            ...
            width={300}
            height={300}
            className="object-contain w-[240px] mt-8"
          />
        </div>
        <div className="w-full h-[250px] md:h-[800px]">
          ...
          <br />
          <br />
          {/* <h1 className="text-center text-3xl font-bold text-primary" data-aos="fade-down">
                        Netaupyk sveikatos sąskaita
                    </h1> */}
          <br />
          {/* <h1 className="text-center text-3xl font-medium text-white" data-aos="fade-up">
                        Maitinkis sveikai čia ir dabar
                    </h1> */}
        </div>
        <div className="space-y-5 black-div-1 text-white">
          ...
          >
            <button
              ...
              data-umami-event="Clicked Register Button"
            >
              Registruokis!
            </button>
          </div>
...
export default PrisijunkAdPage;
