...
//TOOD: Toast to Sonner and Lucide Icons
    ...
    <>
      <div className="w-11/12 my-2 flex flex-col md:flex-row justify-between items-center md:space-x-24">
        <div className="w-full md:w-1/2 flex flex-row justify-start md:justify-between items-center">
          ...
          <div
            className={
              props.data.volumes[0]?.out_of_stock
                ? `text-gray-400 md:w-1/3 text-lg font-medium text-left`
                : `text-primary md:w-1/3 text-lg font-medium text-left`
            }
          >
        ...
        <div className="w-5/6 md:w-1/2 flex flex-row justify-between items-center">
          ...
          <div>
            <button
              className={
                props.data.volumes[0]?.out_of_stock
                  ? `bg-gray-400 text-white py-1 px-7 rounded-lg text-sm`
                  : `bg-secondary text-white py-1 px-7 rounded-lg text-sm`
              }
              onClick={() => {
