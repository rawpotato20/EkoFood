...
const Reviews = () => {
  ...
  const [selectedData, setSelectedData] = useState<Review | null>(null);
        ...
        <>
          <div className="min-h-screen w-full fixed top-0 left-0 z-10 bg-black/60 flex justify-center items-center">
            <div className="container mx-auto bg-white rounded-xl p-3">
              ...
              {selectedData && <EditReviews data={selectedData} />}
            </div>
          </div>
        </>
      )}
        ...
        <>
          <div className="min-h-screen w-full fixed top-0 left-0 z-10 bg-black/60 flex justify-center items-center">
            <div className="container mx-auto bg-white rounded-xl p-3">
              ...
              {selectedData && (
                <DeleteReview data={selectedData} handleClose={handleClose} />
              )}
            </div>
          </div>
        </>
