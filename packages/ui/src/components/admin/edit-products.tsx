...
const EditProducts = (props: EditProductsProps) => {
  ...
  //TODO: Make the type normal
  const [image, setImage] = useState<any>(props.data.image);
  ...
  const [options, setOptions] = useState<OptionsProps>(props.data.options);
