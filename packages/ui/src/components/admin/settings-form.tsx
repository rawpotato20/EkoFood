...
//TODO: Nookies and Toast to Sonner
...
const SettingsForm = () => {
  ...
  const handleAboutPageChange = (i: string) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            {/* <textarea
                            ...
                            required
                        /> */}
            <Editor value={aboutEcoDiscountText} setValue={handleTextChange1} />
          </div>
          <div className="flex flex-col">
            ...
            {/* <textarea
                            ...
                            required
                        /> */}
            <Editor value={aboutPageContent} setValue={handleAboutPageChange} />
          </div>
          {/* <div className="flex flex-col">
