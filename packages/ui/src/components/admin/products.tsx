...
const Products = () => {
  ...
  //TODO: What are the the types of this?
  const updateReorderedProducts = async (newProducts: Product[]) => {
    try {
  ...
  //TODO: What is the type of product?
          ...
          <div className="h-[60vh] overflow-y-scroll">
            <Reorder.Group
              ...
              onReorder={(newOrder) => {
                ...
                const reorderedProducts = newOrder.map((product, index) => ({
                  ...product,
      ...
      {open2 && (
        <div className="fixed inset-0 bg-black/60 flex justify-center items-center">
          <div className="container mx-auto bg-white rounded-xl p-3">
            ...
            {/* TODO: Make this work */}
            {/* {selectedData && <EditProducts data={selectedData} />} */}
          </div>
        </div>
      )}
      {open3 && (
