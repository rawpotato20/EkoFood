...
const EditAds = (props: EditAdsProps) => {
  const router = useRouter();
  const pathname = usePathname();

  const [background, setBackground] = useState<File | null>(null);
  const [backgroundURL, setBackgroundURL] = useState(props.data.background);
  const [background2, setBackground2] = useState<File | null>(null);
  const [backgroundURL2, setBackgroundURL2] = useState(props.data.background2);
